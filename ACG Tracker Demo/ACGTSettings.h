...
@interface ACGTSettings : NSObject
{
    char _videoPreset;
    double _camFocalLength;
    double _camPrincipalX;
    double _camPrincipalY;
}
@property (readonly) const char videoPreset;
@property (readonly) const double camFocalLength;
@property (readonly) const double camPrincipalX;
@property (readonly) const double camPrincipalY;
