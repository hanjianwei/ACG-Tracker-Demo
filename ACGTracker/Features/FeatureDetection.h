...
#ifndef __ACG_Tracker_Demo__FeatureDetection__
#define __ACG_Tracker_Demo__FeatureDetection__
...
namespace ACGT
{
    ...
    public:
        ...
        virtual std::vector<Feature> detect() = 0;
    };
}

#endif /* defined(__ACG_Tracker_Demo__FeatureDetection__) */
